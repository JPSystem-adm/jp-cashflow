...
import {
  WarningBox,
  tipoEnu,
} from "@/app/(app)/_components/warningBox";
...
export default function NovoGrupoForm() {
  ...
  async function onSubmit(values: FormProps) {
    ...
    try {
      ...
      // console.log("MENSAGEM:", retorno.statusText);
  ...
  return (
    <>
      {showAlerta && (
        <WarningBox tipo={tipo} mensagem={mensagem} onCancel={handleFechar} />
      )}
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        ...
        <SheetContent
          ...
          className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2  max-h-[600px] min-w-[780px] overflow-auto rounded-2xl bg-white p-6 shadow-lg"
        >
          <SheetHeader>
...
// // ✅ Importando novos métodos da API REST
// import { criarGrupo } from "@/app/(app)/actions/grupoAPI"
// import { tyGrupoSubGrupo, tySubGrupo, tyResult, tipoGrupo } from "@/types/types";
// import queryClient from "@/lib/reactQuery";
...
//       incluirGrupo(novoGrupo);
//       setIsOpen(false);
//     }
//   }

//   //Função para incluir uma novo grupo com seus subgrupos
//   async function incluirGrupo( dadosGrupo: tyGrupoSubGrupo) {
//     let retorno:tyResult ;
//     try {      
//       retorno = await criarGrupo(dadosGrupo)
...
//           + Grupo
//         </Button>
//         <SheetContent aria-describedby="descricao-grupo" className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2  max-h-[600px] min-w-[780px] overflow-auto rounded-2xl bg-white p-6 shadow-lg">
//           <SheetHeader>
//             <SheetTitle  className="text-2xl text-sky-900">
//               Novo grupo de Contas
//             </SheetTitle>
